...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent fixed-top">
    <div class="container">
        <a class="navbar-brand" href="#">Look4Job</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                ...
                <?php if ($muncul) : ?>
                    ...
                    <a href="/pages/logout" class="btn btn-primary" onclick="return confirm('Yakin ingin keluar?')">Logout</a>
                <?php endif; ?>
                <?php if ($hilang) : ?>
                    <a href="/pages/createPerusahaan" class="btn btn-secondary ml-2">Daftar</a>
                    <a href="/pages/login" class="btn btn-primary ml-2">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
